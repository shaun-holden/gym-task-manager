...
export default function Dashboard() {
  ...
  const [missingPopupDismissed, setMissingPopupDismissed] = useState(
    () => sessionStorage.getItem('missingEodDismissed') === 'true'
  );
  ...
  return (
    <div>
      ...
      <Modal
        ...
        onClose={() => { setShowMissingPopup(false); setMissingPopupDismissed(true); sessionStorage.setItem('missingEodDismissed', 'true'); }}
      ...
      >
        ...
        <div className="flex justify-end mt-4">
          <button
            onClick={() => { setShowMissingPopup(false); setMissingPopupDismissed(true); sessionStorage.setItem('missingEodDismissed', 'true'); }}
