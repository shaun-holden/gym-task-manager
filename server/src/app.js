...
app.post('/api/seed', async (req, res) => {
  ...
  try {
    ...
    await prisma.user.upsert({ where: { email: 'deshaun@tntgym.org' }, update: { role: 'SUPERVISOR' }, create: { email: 'deshaun@tntgym.org', passwordHash: supervisorHash, name: 'DeShaun', role: 'SUPERVISOR' } });
